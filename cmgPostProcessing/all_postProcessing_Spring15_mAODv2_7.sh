...
python cmgPostProcessing.py --skim=dilepTiny  $1 --samples=WWDouble  
python cmgPostProcessing.py --skim=dilepTiny  $1 --samples=WpWpJJ  
python cmgPostProcessing.py --skim=dilepTiny  $1 --samples=WWZ  
python cmgPostProcessing.py --skim=dilepTiny  $1 --samples=WZZ  
python cmgPostProcessing.py --skim=dilepTiny  $1 --samples=ZZZ  
python cmgPostProcessing.py --skim=dilepTiny  $1 --samples=TTWToLNu  
python cmgPostProcessing.py --skim=dilepTiny  $1 --samples=TTWToQQ  
python cmgPostProcessing.py --skim=dilepTiny  $1 --samples=TTZToQQ  
python cmgPostProcessing.py --skim=dilepTiny  $1 --samples=TTZToLLNuNu  
python cmgPostProcessing.py --skim=dilepTiny  $1 --samples=TTGJets  
