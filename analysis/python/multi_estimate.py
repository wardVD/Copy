...
signalEstimates = [ MCBasedEstimate(name=s['name'],    sample={channel:s for channel in allChannels}, cacheDir=setup.getDefaultCacheDir() ) for s in signals_T2tt ]
...
for estimate in estimates+signalEstimates:
  jobs=[]
