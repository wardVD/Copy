...
#Concrete implementation of abstract method 'estimate' as defined in Systematic
  def _estimate(self, region, channel, setup):
    ...
    threeLeptonSel = "(1)" #use whatever
    selection_3l = "&&".join([
#      region.cutString(setup.sys['selectionModifier']), ??? is this not a bug? 
      setup.selection('MC', channel=channel, zWindow = 'offZ', nJets = (4,-1), nBTags= (2,-1), addLeptonSelection = False),
      threeLeptonSel
    ])
