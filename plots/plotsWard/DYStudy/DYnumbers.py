...
preselection = presel_met+'&&'+presel_njet+'&&'+presel_metsig+'&&'+presel_mll+'&&'+presel_ngoodlep+'&&'+presel_OS+'&&'+presel_dPhi+'&&'+presel_flavour
...
plots = {\
  'mumu':{\
    'mt2llonZ': {'title':'M_{T2ll} (GeV)', 'name':'MT2llonZ', 'binning': mt2llbinning, 'histo':{}},
    'mt2lloffZ': {'title':'M_{T2ll} (GeV)', 'name':'MT2lloffZ', 'binning': mt2llbinning, 'histo':{}},
  },
  'ee':{\
    'mt2llonZ': {'title':'M_{T2ll} (GeV)', 'name':'MT2llonZ', 'binning': mt2llbinning, 'histo':{}},
    'mt2lloffZ': {'title':'M_{T2ll} (GeV)', 'name':'MT2lloffZ', 'binning': mt2llbinning, 'histo':{}},
