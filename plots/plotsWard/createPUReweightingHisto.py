...
prefix="doubleMu_onZ_isOS_1500pb_ward"

#load all the samples
from StopsDilepton.samples.cmgTuples_Spring15_mAODv2_25ns_1l_postProcessed import *
from StopsDilepton.samples.cmgTuples_Data25ns_mAODv2_postProcessed import *

backgrounds = [QCD_Mu5,WJetsToLNu,singleTop,DY_HT_LO,singleTop,TTX,TTJets] 
...
#  l.AddEntry(signalPlot, signal+" x 100")
  ...
  c1.Print(plotDir+"/pileup/"+prefix+'_'+plots[pk]["name"]+"_reweight.png")
  f = ROOT.TFile(plotDir+"/pileup/"+prefix+'_'+plots[pk]["name"]+"_reweight.root", "recreate")
